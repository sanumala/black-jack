...
import com.satesh.blackjack.model.GameAlreadyCompleteException;
import com.satesh.blackjack.model.GameNotFoundException;
import com.satesh.blackjack.model.GameStore;
import com.satesh.blackjack.view.Card;
import com.satesh.blackjack.view.GameState;
import com.satesh.blackjack.view.Hand;
import com.satesh.blackjack.view.Rank;
import com.satesh.blackjack.view.Status;
...
public class BlackjackControllerTest {
   ...
   public void updateGame_InvalidActionParameter() throws Exception {
      ...
      String expectedExceptionMessage = "Failed to convert value of type 'java.lang.String' to required type 'com.satesh.blackjack.view.Action'; "
                                        ...
                                        + "[@org.springframework.web.bind.annotation.RequestParam @io.swagger.annotations.ApiParam com.satesh.blackjack.view.Action] for value 'DOUBLE'; "
                                        + "nested exception is java.lang.IllegalArgumentException: No enum constant com.satesh.blackjack.view.Action.DOUBLE";
